...
typedef enum {CON_SERV,ACK_CON,DEM_AMI,DEM_CON_AMI,CMD_CON,CMD_HOME,CMD,LS_RET,CD_RET,CMD_END, DEM_FIC,ENV_FIC,ACK,FIN_CON_AMI,FIN_CON_SERV, ERROR, CHECK_CON} TypeTrame; 
